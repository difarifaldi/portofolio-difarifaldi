  ...
  return (
    <div className="bg-gray-800 p-6 pt-24" id="contact">
      <div className="flex flex-col sm:flex-row items-center justify-center gap-6 max-w-6xl mx-auto mt-6">
        ...
        {/* Bagian Gambar */}
        <motion.div className="w-full md:w-1/2  h-auto border-4 border-gray-300 overflow-hidden" initial={{ opacity: 0, x: 100 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 1 }}>
          <iframe
